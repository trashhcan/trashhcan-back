...
public class OAuth2MemberService {
    ...
    public MemberResponseDto signUpOrIn(GoogleAccountProfileResponse googleAccountInfo, String provider){
        // 이미 회원이면 회원 객체 반환, 새로운 회원이면 회원 생성 & DB 저장 후 반환
        Member member = memberRepository.findByEmail(googleAccountInfo.getEmail())
